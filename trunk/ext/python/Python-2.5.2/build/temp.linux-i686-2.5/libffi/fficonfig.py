...
ffi_srcdir = '/home/taf2/project/ruby-python/trunk/ext/python/Python-2.5.2/Modules/_ctypes/libffi'
ffi_sources += ffi_platforms['X86']
ffi_sources = [os.path.join('/home/taf2/project/ruby-python/trunk/ext/python/Python-2.5.2/Modules/_ctypes/libffi', f) for f in ffi_sources]
